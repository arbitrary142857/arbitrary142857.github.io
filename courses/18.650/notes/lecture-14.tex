...
\begin{theorem}{Bootstrap Properties}
    ...
    and suppose $\{X_i^*\}_{i = 1}^m$ is some bootstrap sample of $\{X_i\}_{i = 1}^n$.
    \begin{enumerate}
        \item We have $\mathbb{E}[X_i^* \mid \{X_i\}_{i = 1}^n] = \bar{X}_n$.
        \item We have $\mathbb{E}[X_i^*] = \mu$.
        \item We have $\mathbb{V}[X_i^* \mid \{X_i\}_{i = 1}^n] =
        \frac{1}{n} \sum_{i = 1}^n X_i^2 - (\bar{X}_n)^2 = \hat{\sigma}_n^2$.
        \item We have $\mathbb{V}[X_i^*] = \sigma^2$.
    \end{enumerate}
\end{theorem}
