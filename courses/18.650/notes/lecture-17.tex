...
= \frac{\sqrt{164}}{12}(33.4 - 30) = 3.62. \]
The test $\Psi$ rejects $H_0$ if $3.62 > z_{\alpha}$.
The least $\alpha$ for which this occurs is $1 - \Phi(3.62) \approx 0.02\%$,
so the $p$-value is $0.02\%$, and we have very strong evidence against $H_0$.
