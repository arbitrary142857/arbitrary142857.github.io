...
\begin{remark}
    \textcolor{red}{TODO: explain what 2-wise independence is}
\end{remark}
...
\begin{proof}
    ...
    Removing any of these $(k + 1)$-tuples does not affect the final result of the algorithm.  Remove $(k + 1)$-tuples until you cannot any longer; the resulting stream still has every $x$ that appears more than $\frac{1}{k}$ of the time. ~ $\blacksquare$
\end{proof}
...
\begin{problem}{Similarity Search}
    Given a collection of sets and a query, return the sets most similar to the query.
\end{problem}
